 ...
 * @LastEditors: wangph
 * @LastEditTime: 2021-04-28 14:37:43
 */
...
class Seckill extends Activity
{
    /**
     * 秒杀活动列表
     * @return mixed
    ...
    public function index()
    {
        ...
        return Format::ins()//实例化
            ...
            ->setRightButton(['title' => lang('活动商品'), 'href' => ['goods/activity_details/index', ['activity_id' => '__id__', 'type' => 1]], 'class' => 'mr5 font12'])
