...
/**
 * 活动分类控制器
 * @package app\Seckill\admin
 */
class CutPrice extends Activity
{
    /**
     * 砍价活动列表
     * @author jxy [41578218@qq.com]
    ...
    public function index()
    {
        ...
        array_unshift($this->top_button, ['ident'=> 'add', 'title'=>lang('新增'), 'href'=>'add?type=5', 'icon'=>'fa fa-plus pr5','class'=>'btn btn-sm mr5 btn-primary btn-flat']);
        return Format::ins()//实例化
        ->addColumns($fields)//设置字段
        ->setTopButton(['title' => lang('新增'), 'data-toggle' => 'dialog-right', 'href' => ['add', ['layer' => 1, 'reload' => 1, 'type' => 5]], 'icon' => 'fa fa-plus pr5', 'class' => 'btn btn-sm mr5 btn-primary btn-flat'])
            ->setTopButtons($this->top_button, ['add'])
            ->setRightButton(['title'=>lang('活动商品'),'href'=>['goods/activity_details/index',['activity_id'=>'__id__','type'=>5]],'class'=>'mr5 font12'])
