...
class Index extends Admin
{
    ...
    public function Setting(){
        ...
        if ($this->request->isPost()) {
            ...
            $data['user_nickname'] == '' && $this->error(lang('昵称不能为空'));
            $data['id'] = UID;
        ...
        $fields =[
            ...
            ['type'=>'static', 'name'=>'user_name', 'title'=>lang('真实姓名'), 'tips'=>lang('不可更改')],
            ['type'=>'text', 'name'=>'user_nickname', 'title'=>lang('昵称'), 'tips'=>lang('可以是中文')],
            ['type'=>'password', 'name'=>'password', 'title'=>lang('密码'), 'tips'=>lang('6-20位，如不修改请保持为空')],
