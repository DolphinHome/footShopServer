...
class Menu extends Base
{
    ...
    public function add($pid = 0)
    {
        ...
        $fields = [
            ...
            ['type' => 'select', 'name' => 'pid', 'title' => lang('上级菜单'), 'tips' => '', 'extra' => MenuModel::getMenuTree(0), 'value' => $pid],
            ['type' => 'text', 'name' => 'title', 'title' => lang('菜单名称'), 'tips' => '', 'attr' => '', 'value' => ''],
            ['type' => 'icon', 'name' => 'icon', 'title' => lang('图标'), 'tips' => '', 'attr' => '', 'value' => ''],
            ['type' => 'text', 'name' => 'url_value', 'title' => lang('链接地址'), 'tips' => '', 'attr' => '', 'value' => ''],
            ['type' => 'radio', 'name' => 'auto_create', 'title' => lang('自动添加子菜单'), 'extra' => [lang('否'), lang('是')], 'value' => 0, 'tips' => lang('子菜单包含新增、编辑、设置状态、删除')],
            ['type' => 'number', 'name' => 'sort', 'title' => lang('排序'), 'tips' => '', 'attr' => '', 'value' => '0'],

        ];
        $this->assign('page_title', lang('新增会员菜单'));
    ...
    public function edit($id = null)
    {
        ...
        $fields = [
            ...
            ['type' => 'select', 'name' => 'pid', 'title' => lang('上级菜单'), 'tips' => '', 'extra' => MenuModel::getMenuTree()],
            ['type' => 'text', 'name' => 'title', 'title' => lang('菜单名称'), 'tips' => '', 'attr' => ''],
            ['type' => 'icon', 'name' => 'icon', 'title' => lang('图标'), 'tips' => '', 'attr' => ''],
            ['type' => 'text', 'name' => 'url_value', 'title' => lang('链接地址'), 'tips' => '', 'attr' => ''],
            ['type' => 'number', 'name' => 'sort', 'title' => lang('排序'), 'tips' => '', 'attr' => ''],

        ];
        $this->assign('page_title', lang('编辑会员菜单'));
