...
class DySms extends Addons
{
    ...
    public $admin = [
        ...
        // 右侧按钮
        'right_buttons' => [
            ['ident'=> 'edit', 'title'=>'编辑','href'=>['edit', ['id'=>'__id__', 'name' => 'DySms']],'icon'=>'fa fa-pencil pr5','class'=>'btn btn-xs mr5 btn-success '],
			['ident'=> 'delete', 'title'=>'删除','href'=>['delete',['ids'=>'__id__', 'name' => 'DySms', 'table'=>'addons_dysms']], 'icon'=>'fa fa-times pr5','class'=>'btn btn-xs mr5 btn-danger  ajax-get confirm'],
        ],
